  ...
  return (
    <div className="centered">
        <form className={style.auth_card} onSubmit={(e)=>SubmitHandler(e)}>
            ...
            <Button variant="solid"  width='17rem' colorScheme="teal" disabled={submitMode} error={submitMode} type="submit">Login</Button>
            <div className={textAuth}>Do not have an account? <Link to="/signup" className="link"><span className={`text-span ${style.account_check}`}>Signup <ChevronRightIcon /></span></Link></div>
        </form>
    </div>
  )
}
